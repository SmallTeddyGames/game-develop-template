...
项目中还使用了 `vue-i18n` 来做国际化配置，如果需要使用国际化的小伙伴，可以参考官网的开发文档：[vue-i18n 官网](https://vue-i18n.intlify.dev/)。

您可以基于项目中的 `i18n` 配置，在 `src/i18n` 目录下，添加您需要的语言包，并在 `src/i18n/index.ts` 中进行修改。
...
项目中使用了 `vue-i18n` 来做国际化配置，具体配置在 `src/i18n/index.ts` 中。
